...
# 使用示例
# from pythonprojecttemplate.core.config import config
...
class Config:
    ...
    def _load_config(self):
        ...
        self._config = self._load_yaml_file(os.path.join(config_dir, f'{env}.yaml'))
    ...
    def get_time_zone(self):
        """获取时区配置，返回有效的时区字符串"""
        time_zone = self._env_config.get('TIME_ZONE')
        # 如果时区为空或无效，返回默认值
